...
import br.upf.ccc.fichaMedica.dtos.ErrorResponseDTO
...
class ExceptionHandler {
    ...
    fun handleNotFound(
        ...
        return ErrorResponseDTO(
            tipoUsuario = HttpStatus.NOT_FOUND.value(),
    ...
    fun handleServerError(
        ...
        return ErrorResponseDTO(
            tipoUsuario = HttpStatus.INTERNAL_SERVER_ERROR.value(),
    ...
    fun handleValidationError(
        ...
        return ErrorResponseDTO(
            tipoUsuario = HttpStatus.BAD_REQUEST.value(),
